...
public enum EnumMolecule {
	...
	// end polyketides
	salt 					(88, "Sodium Chloride", new Element(Na,1), new Element(Cl,1)), 
	nh3  					(89, "Aqueous Ammonia", new Element(N,1), new Element(H,4), new Molecule(hydroxide)),
	nod 					(90, "Nodularin", new Element(C,41), new Element(H,60), new Element(N,8), new Element(O,10)),
	potato                  (91, "Digoxin", new Element(C,41), new Element(H,64), new Element(O,14)), // Will come from bad potatos
	ttx                     (92, "TTX (Tetrodotoxin)", new Element(C,11), new Element(H,11), new Element(N,3),new Element(O,8)), // Could come from spider eyes
	;
