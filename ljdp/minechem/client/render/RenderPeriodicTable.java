...
import ljdp.minechem.common.entity.EntityPeriodicTable;
...
public class RenderPeriodicTable extends Render {

	@Override
	public void doRender(Entity entity, double x, double y, double z, float angle, float scale) {
		this.renderPeriodicTable((EntityPeriodicTable)entity, x, y, z, angle, scale);
	}
	
	public void renderPeriodicTable(EntityPeriodicTable periodicTable, double x, double y, double z, float angle, float scale) {
		GL11.glPushMatrix();
	...
	private void renderArt(EntityPeriodicTable periodicTable, int sizeX, int sizeY, int offsetX, int offsetY) {
	...
	private void setLighting(EntityPeriodicTable periodicTable, float par2, float par3) {
